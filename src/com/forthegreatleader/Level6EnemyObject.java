 ...
 */
public class Level6EnemyObject extends EnemyObject{
	//It makes more sense to define these here. More consistent
	private static final int HEIGHT = 20;
	private static final int WIDTH = 20;
	private static final int LIFE = 100;
	private static final int COLOUR = Color.rgb(100, 100, 205);
	//protected int BODY_PART_LIFE = 50;
	
	public Level6EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList spriteList, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
	...
	//No bitmap
	public Level6EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
