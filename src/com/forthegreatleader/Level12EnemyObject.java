 ...
 */
public class Level12EnemyObject extends EnemyObject{
	private static final int HEIGHT = 8;
	private static final int WIDTH = 8;
	private static final int WEAPON_HEIGHT = 4;
	private static final int WEAPON_WIDTH = 2;
	private static final int LIFE = 10;
	private static final int WEAPON_LIFE = 1;
	private static final int WEAPON_POWER = 7;
	private static final int PROJECTILE_COLOUR = Color.rgb(205, 155, 155);
	private static final int COLOUR = Color.rgb(105, 5, 55);
	...
	public Level12EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList spriteList, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
	...
	//No bitmap
	public Level12EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
