 ...
 */
public class Level104EnemyObject extends EnemyObject{
...
//	private static final float WEAPON_FIRE_RATE = 4.0f;
	...
	public Level104EnemyObject(int posX, int posY, float ySpeed, CanvasPacket canvasPack, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
