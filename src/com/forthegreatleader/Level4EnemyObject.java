 ...
 */
public class Level4EnemyObject extends EnemyObject{
	//It makes more sense to define these here. More consistent
	private static final int HEIGHT = 25;
	private static final int WIDTH = 25;
	private static final int LIFE = 200;
	private static final int COLOUR = Color.rgb(205, 100, 100);
	//protected int BODY_PART_LIFE = 50;
	
	public Level4EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList spriteList, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
	...
	//No bitmap
	public Level4EnemyObject(int posX, int posY, MovementPacket movementPack, CanvasPacket canvasPack, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
