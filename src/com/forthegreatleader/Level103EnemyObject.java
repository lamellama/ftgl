 ...
 */
public class Level103EnemyObject extends EnemyObject{
...
//	private static final int TRAIL_COLOUR = Color.BLUE;
	private static final int COLOUR = Color.rgb(55, 145, 55);
//	private static final float WEAPON_FIRE_RATE = 4.0f;
	private static final int OUTLINE_COLOUR = Color.rgb(25, 25, 25);
	
	public Level103EnemyObject(int posX, int posY, float ySpeed, CanvasPacket canvasPack, SharedBitmapList explosionBitmapList, Vector<ProjectileObject> projectileList){
